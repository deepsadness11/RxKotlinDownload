...
import static cry.com.download.zlc.season.rxdownload2.function.Constant.*;
    ...
    public static class ContinueDownload extends DownloadType {
        ...
        private Publisher<DownloadStatus> rangeDownload(final int index) {
            return record.rangeDownload(index)
                    ...
                    .compose(Utils.<DownloadStatus>retry2(Utils.formatStr(RANGE_RETRY_HINT, index), record.getMaxRetryCount()));
        }
