...
import cry.com.download.zlc.season.rxdownload2.entity.DownloadType;
import cry.com.download.zlc.season.rxdownload2.entity.TemporaryRecord;
...
import static cry.com.download.zlc.season.rxdownload2.function.Constant.REQUEST_RETRY_HINT;
...
public class DownloadHelper {
    ...
    private void addTempRecord(DownloadBean bean) {
        if (recordTable.contain(bean.getUrl())) {
            throw new IllegalArgumentException(Utils.formatStr(Constant.DOWNLOAD_URL_EXISTS, bean.getUrl()));
        }
                ...
                .doOnNext(new Consumer<Response<Void>>() {
                    ...
                    public void accept(Response<Void> response) throws Exception {
                        if (!response.isSuccessful()) {
                            throw new IllegalArgumentException(Utils.formatStr(Constant.URL_ILLEGAL, url));
                        } else {
    ...
    private ObservableSource<Object> checkRange(final String url) {
        return downloadApi.checkRangeByHead(Constant.TEST_RANGE_SUPPORT, url)
                .doOnNext(new Consumer<Response<Void>>() {
                    @Override
                    public void accept(Response<Void> response) throws Exception {
